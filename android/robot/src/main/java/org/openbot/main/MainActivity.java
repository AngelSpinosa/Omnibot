...
public class MainActivity extends AppCompatActivity {
  ...
  private static final String TAG = "MainActivity"; // Definir el TAG para los registros
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (OpenCVLoader.initDebug()) {
      ...
      return; // Salir si OpenCV no se inicializa correctamente
    }
            ...
            if (action != null) {
              switch (action) {
                case UsbManager.ACTION_USB_DEVICE_ATTACHED:
                  ...
                  break;
                // Caso activado cuando la aplicación no está configurada para abrirse de forma predeterminada cuando se conecta USB
    ...
    navController.addOnDestinationChangedListener(
        (controller, destination, arguments) -> {
          ...
          // Para actualizar el icono de la barra de herramientas según el Fragmento.
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    // Obtener el ID de destino actual.
